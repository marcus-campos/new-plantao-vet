...
def client_ip(request: Request) -> str:
    ...
    if encaminhado:
        # O ÚLTIMO hop, não o primeiro: o Caddy ANEXA o IP que observou ao
        # valor que chegou, então o primeiro elemento é exatamente a parte
        # que o cliente controla. Confiar nele deixaria o limite de cinco
        # por hora a um header de distância de ser burlado, nesta que é a
        # única rota que cria uma clínica sem credencial nenhuma.
